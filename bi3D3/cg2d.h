...
typedef struct HPoint2D {
  ...
  int   color;
  float br; // utilizado na parte tridimensional
        } point2d;
...
point2d * SetVertex2d(float, float, float, int);
...
float GetIntensity(polygon *, int);
...
int Orientation(point2d, point2d, point2d);
int FindBottomLeft(point2d *, int);
void SortAntiClockwise(point2d *, int);
float area(point2d *, point2d *, point2d *);
point2d * InterPolTrian(polygon *, point2d *);
point2d * InterPolQuadr(polygon *, point2d *); // em desenvolvimento
point2d * Interpolate(polygon *, point2d *);
